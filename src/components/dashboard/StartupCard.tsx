...
export default function StartupCard({
  ...
  return (
    <Link href={`/startupinfo`}>
      <div className="flex w-auto gap-4 rounded-2xl border border-slate-400 bg-white p-2 hover:shadow-lg transition-shadow duration-200 cursor-pointer md:flex-row md:items-center md:p-4">
        <Image
          src={logo}
          width={100}
          height={100}
